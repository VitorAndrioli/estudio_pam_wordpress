...
Plugin URI: http://www.web-developers.net/blog/?page_id=28

Description: A plugin which allows you to set-up words which are automatically hyperlinked to desired URLs
...
*/
 ...
 function cross_linker()

  {
   ...
   echo "<font style='font-size: 10px;'>&raquo;brought to you by <a href=\"http://www.web-developers.net/\">Web-Developers.Net</a>; read why you should make a donation at the bottom of this page; suggestions are welcome only after making a donation - <a href=\"http://services-seo.net/\" target=\"_blank\">read how to donate</a><br />&raquo;if you're new to this plugin, visit <a href=\"http://www.web-developers.net/blog/?page_id=28\" target=\"_blank\">web-developers.net/blog/?page_id=28</a> where you can learn how it works<br />&raquo;problems? email me: <a href=\"mailto:postmaster@aqua-fish.net\">postmaster@aqua-fish.net</a><br /><br /></font>";



   //don't show news - uncomment if news should be shown

   /*

   $news = $wpdb->get_var("SELECT value FROM $table_name WHERE setting = 'valid_code_131' limit 1;");

   if(($news!=0)||($news==''))

    echo "<font style=\"color: red\">If possible, always use valid XHTML (or HTML) code in your posts. Invalid XHTML code may cause this plugin to act unpredictably. Official validator can be found here: <a href=\"http://validator.w3.org\" target=\"_blank\">validator.w3.org</a>.</font>

         <form action=\"".$fix_uri."\" method=\"post\">

          <input type=\"hidden\" name=\"valid_code_131\" value=\"1\" />

          <input type=\"submit\" value=\"Never show this message again!\" />

         </form><br />";



   $news = $wpdb->get_var("SELECT value FROM $table_name WHERE setting = 'forgot_something_130' limit 1;");

   if(($news!=0)||($news==''))

    echo "<font style=\"color: red\">If you're one of guys who suggested me to add something into this plugin and if I forgot to do so, then I am sorry. Just visit <a href=\"http://services-seo.net/blog/?p=98\" target=\"_blank\">this link</a> and explain me what I should do in order to satisfy your expectations :). Describe the thing as clearly as possible, please.</font>

         <form action=\"".$fix_uri."\" method=\"post\">

          <input type=\"hidden\" name=\"forgot_something_130\" value=\"1\" />
   ...
   $news = $wpdb->get_var("SELECT value FROM $table_name WHERE setting = 'news_1_2' limit 1;");

   if(($news!=0)||($news==''))

    echo "<font style=\"color: red\">Please check new features which can be found at the bottom of this page. They were designed to help you controlling this plugin effectively and easily.</font>

         <form action=\"".$fix_uri."\" method=\"post\">

          <input type=\"hidden\" name=\"show_news_12\" value=\"1\" />
   ...
   $news = $wpdb->get_var("SELECT value FROM $table_name WHERE setting = 'recommend_link_12' limit 1;");

   if(($news!=0)||($news==''))

    echo "<font style=\"color: red\">If you haven't done yet, consider placing a link to <a href=\"http://www.web-developers.net\" target=\"_blank\">Web-Developers.Net</a> from your blog, please. I am working hard to bring you new features, therefore a small link from your blog will be the best way how to say \"Thank you!\"</font>

         <form action=\"".$fix_uri."\" method=\"post\">

          <input type=\"hidden\" name=\"recommend_link_12\" value=\"1\" />
   ...
   $news = $wpdb->get_var("SELECT value FROM $table_name WHERE setting = 'bigchanges' limit 1;");

   if(($news!=0)||($news==''))

    echo "<font style=\"color: red\">This new version comes with new features. This is why it is recommended to create the backup firstly. Also, go from top to bottom (of this page) in order to see what's new :) .</font>

         <form action=\"".$fix_uri."\" method=\"post\">

          <input type=\"hidden\" name=\"bigchanges\" value=\"1\" />
   ...
   $news = $wpdb->get_var("SELECT value FROM $table_name WHERE setting = 'bug_reports_12' limit 1;");

   if(($news!=0)||($news==''))

    echo "<font style=\"color: red\">If you find any problem with this plugin, visit <a href=\"http://www.web-developers.net/contact/\" target=\"_blank\">Web-Developers.Net's contact page</a> or <a href=\"http://services-seo.net/blog/?page_id=2\" target=\"_blank\">the contact page on my (Jan Hvizdak - the developer of this plugin) website</a> and tell me about your problem there, please! Suggestions <b>should</b> be sent here: <a href=\"http://services-seo.net/blog/?p=98\" target=\"_blank\">http://services-seo.net/blog/?p=98</a>.</font>

         <form action=\"".$fix_uri."\" method=\"post\">

          <input type=\"hidden\" name=\"bug_reports_12\" value=\"1\" />
   ...
   if(($crosslinker_version=='1.4.3')&&($wpdb->get_var("SELECT value FROM $source_table WHERE setting = 'quotes_news_143' LIMIT 1;",0)==''))
   ...
   echo "<div><h3><a href=\"#h_1\" onclick=\"javascript:make_cookie('hyperlink_console');ReverseContentDisplay('hyperlink_console');\" name=\"h_1\">Open/Close The Console For Hyperlinking</a></h3>
                         ...
                         Specify the word/phrase below, please (more words/phrases MUST be divided by | . For example: <i>seo|web design|seo services</i> - each of these phrases will point to the specified URL)<br /><input type=\"text\" name=\"linker_word\" value=\"".$linkto_word."\" /><br />

                         Specify the destination URL, please (starting with the <em>http://</em> prefix)<br /><input type=\"text\" name=\"linker_uri\" value=\"".$linkto_uri."\" id=\"linkeruri\" /> ".$add_permalinks."<br />
  ...
  if($_POST['ignored_chars']!='')
   ...
   echo "If you are using thus plugin, it will be <strong>cool</strong> if you linked back to <a href=\"http://www.web-developers.net/\">Web-Developers.Net</a>. For this purpose you can activate the following setting. A small link will be added to the footer of your blog. Of course, you can add a link to your blogroll instead of activating this option. <em>The more people know about this plugin, the better for users of <a href=\"http://wordpress.org\">WordPress</a>!</em>

   <br /><br /><form action=\"".$fix_uri."\" method=\"post\" name=\"formsetting\">

   <input type='checkbox' name='link_to_thrusites' ".$checked." /> Link to <a href=\"http://www.web-developers.net/\">Web-Developers.Net</a>? (recommended)<br />
   ...
   echo "<div><h3><a href=\"#h_7\" onclick=\"javascript:make_cookie('manage_imports');ReverseContentDisplay('manage_imports');\" name=\"h_7\">Open/Close The Console For Managing Imports/Exports</a></h3>";
   ...
   echo "<div style=\"border-top: solid 1px #A9A9F2; border-left: solid 1px #B5B5ED; border-bottom: solid 1px #B5B5ED; border-right: solid 1px #A9A9F2; padding: 1em;\">";

   echo "<h3>Why make a donation?</h3>Because I am continuously developing this plugin. If you're ignoring this fact, then don't expect me to add new features into the core! <strong>Thanks a lot to those who sent me donations!</strong> This version has been released thanks to those few people. Further details about donations can be found <a href=\"http://services-seo.net/blog/?p=99\" target=\"_blank\">here</a>.<br /><br />

   OK, some of you cannot donate and I understand it. In such a case if you link from your blog to my <a href=\"http://www.aqua-fish.net\" target=\"_blank\">aqua-fish.net</a> and to <a href=\"http://www.web-developers.net\" target=\"_blank\">web-developers.net</a>, it would be enough to consider your suggestions. Donations or links are necessary to make me hear your ideas.";
...

       {
        ...
        if($presiel==1)

         {
          ...
          /*echo "<h1>JUST TESTING</h1>".htmlspecialchars(substr($new_part,$starting_pos))."<br />";

          if(@strpos($old_part,">")!==false)

           {

            $invalid_code_close_position = @strpos($old_part,">");

            if(@strpos($old_part,"<")!==false)

             {

              $invalid_code_begin_position = @strpos($old_part,"<");

              if($invalid_code_begin_position<$invalid_code_close_position)
 ...
 function test_func()

  {
   ...
   if($wpdb->get_var("SELECT value FROM $t4 WHERE setting = 'link_to_thrusites' LIMIT 1;",0)=='1')
    ...
    echo "<p align='center' style='font-size: 10px;'>This blog uses the cross-linker plugin developed by <a href=\"http://www.web-developers.net\">Web-Developers.Net</a></p>";
 ...
 if($_SERVER['QUERY_STRING']=='activate=true')
