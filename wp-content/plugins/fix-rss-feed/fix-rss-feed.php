...
?>
  ...
  <blockquote>
  <p><input type="radio" value="order" name="supportaction" id="supportaction" checked onClick="document.getElementById('supportaction').value = 'order';">Donate $4.99&nbsp;   
  ...
  <input type="radio" value="none" name="supportaction" id="supportaction" onClick="document.getElementById('supportaction').value = 'none';">None</p>
  </blockquote>
