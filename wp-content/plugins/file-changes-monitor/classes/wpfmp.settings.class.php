...
<pre>location ~ /\. {
    return 404;
        ...
        static public function sc_wpfmp_settings_main_field_file_check_method()
        {
            ...
            <input name="<?php echo sc_WordPressFileMonitorPlus::$settings_option_field ?>[file_check_method][md5]" type="checkbox" value="1" <?php checked( $options['file_check_method']['md5'], 1 ); ?> /><?php _e( " File Hash", WFM3_I18N ); ?>
            <?php
        }
