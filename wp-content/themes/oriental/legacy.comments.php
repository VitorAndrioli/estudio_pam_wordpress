...
<?php if ($comments) : ?>
	...
	<?php
		...
		$oddcomment = ( empty( $oddcomment ) ) ? ' legacyAlt' : '';
...
<div><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
