			...
			<div class="menu span-24">
				...
				<ul class="menu-wrapper">
					...
					<?php if ($gear_home_visibility == "on") { ?>

					<li class="first <?php if ( is_home() ) { ?>current_page_item<?php } ?>"><a href="<?php echo get_option('home'); ?>/" title="<?php _e('A link to home page', 'default'); ?>"><?php echo stripslashes($gear_home_label); ?></a></li>
